<template>
    <div class="p-10 bg-slate-50 min-h-screen">
        ...
        <Dialog headerTitle="Delete User" :show="deleteDialog" @close="handleChangeDeleteDialaog" submit-text="Delete" submit-type="danger">
...
import { customers } from "./data/user"
...
onMounted(() => {
    dataTableStore.init(customers, userHeader);
})
</script>
