<template>
    <header class="min-h-[5rem] flex justify-between items-center px-12">
        ...
        <div>
            <a class="font-medium tracking-wide mx-8 text-slate-800 hover:text-orange-600" href="#">Login</a>
            <a class="font-medium tracking-wide mx-8 bg-orange-600 text-white px-6 py-2 rounded hover:bg-orange-700 transition" href="#">Sign Up</a>
        </div>
    </header>
</template>
