    ...
    <div class="py-20" id="services">
        ...
        <div class="flex justify-around mx-20">
            <div class="services-card max-w-[360px] bg-slate-100 p-8 rounded shadow-md hover:bg-orange-500">
                ...
                <h1 class="text-center text-orange-950 tracking-wide font-bold text-xl mb-2">Lorem Ipsum</h1>
                <p class="text-center text-orange-900/70 tracking-wide text-sm">
            ...
            <div class="services-card max-w-[360px] bg-slate-100 p-8 rounded shadow-md hover:bg-orange-500">
                ...
                <h1 class="text-center text-orange-950 tracking-wide font-bold text-xl mb-2">Lorem Ipsum</h1>
                <p class="text-center text-orange-900 tracking-wide text-sm">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Expedita repudiandae quia tenetur aspernatur
                </p>
            </div>
            <div class="services-card max-w-[360px] bg-slate-100 p-8 rounded shadow-md hover:bg-orange-500">
                ...
                <h1 class="text-center text-orange-950 tracking-wide font-bold text-xl mb-2">Lorem Ipsum</h1>
                <p class="text-center text-orange-900 text-sm">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Expedita repudiandae quia tenetur aspernatur
                </p>
            </div>
